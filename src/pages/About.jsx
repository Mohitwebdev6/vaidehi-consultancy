...
const About = () => {
  useSeo({
    title: "Vaidehi Consultancy | About",
    description:
      "Learn about Vaidehi Consultancy, our mission, and how we help businesses grow with technology.",
  });

  const approachItems = [
    {
      title: "Business-first technology solutions",
      icon: <Rocket size={24} />,
    },
    {
    ...
    {
      title: "Quality-driven development and design",
      ...
      <section className="bg-[#0f172a] pt-32 pb-48 px-6 text-center text-white relative">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto">
            A technology-driven consultancy committed to building long-term
          ...
          <div className="flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="md:w-2/3">
              <p className="text-lg text-slate-600 leading-relaxed mb-6">
                Vaidehi Consultancy is a growing IT consultancy based in India,
                focused on helping businesses, startups, and institutions build
                a strong digital presence.
              </p>
              <p className="text-lg text-slate-600 leading-relaxed font-medium">
                We specialize in website development, digital marketing, and
                website designing, delivering solutions that are reliable,
                scalable, and business-focused.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-4xl font-bold text-slate-900 mb-6">
                Why Vaidehi Consultancy
              </h2>
              <div className="w-16 h-1.5 bg-sky-500 rounded-full mb-8"></div>
              <p className="text-xl text-slate-600 leading-relaxed">
                We believe technology should simplify business, not complicate
                it. Our goal is to work as an extension of your team to provide
